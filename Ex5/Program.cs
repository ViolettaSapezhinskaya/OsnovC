...
if (I < 18.5)
{
    ...
    double x= 18.5 * h2;
    x -= m;
    Console.WriteLine($"Вам нужно набрать {x} кг, чтобы ваш ИМТ был в норме");
}
else if (I > 25)
{
    ...
    double x = 25 * h2;
    m -= x;
    Console.WriteLine($"Вам нужно скинуть {m} кг, чтобы ваш ИМТ был в норме");
}
else
{
    Console.WriteLine("Ваш вес в норме");
}
//Дописать программу чтобы кол-во кг было без знаков после запятой